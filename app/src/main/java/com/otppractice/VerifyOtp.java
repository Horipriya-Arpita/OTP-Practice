...
import com.otppractice.databinding.ActivityVerifyOtpBinding;
...
public class VerifyOtp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.tvMobile.setText(String.format(
                "+88",getIntent().getStringExtra("phone")
        ));
                                ...
                                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                    ...
                                    public void onComplete(@NonNull @NotNull Task<AuthResult> task) {
                                        if (task.isSuccessful()) {
                                            binding.progressBarVerify.setVisibility(View.VISIBLE);
                                            binding.btnVerify.setVisibility(View.INVISIBLE);
                                            Toast.makeText(VerifyOtp.this, "Welcome...", Toast.LENGTH_SHORT).show();
