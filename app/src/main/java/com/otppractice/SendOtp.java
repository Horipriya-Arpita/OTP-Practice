...
import com.otppractice.databinding.ActivitySendOtpBinding;
        ...
        binding.btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (binding.etPhone.getText().toString().trim().isEmpty()) {
                    ...
                    Toast.makeText(SendOtp.this, "Type valid Phone Number", Toast.LENGTH_SHORT).show();
                } else {
                    otpSend();
                }
            }
    ...
    private void otpSend() {
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(FirebaseException e) {
                ...
                Toast.makeText(SendOtp.this, "Jhaamela", Toast.LENGTH_SHORT).show();
            }
        ...
        PhoneAuthOptions options =
                PhoneAuthOptions.newBuilder(mAuth)
                        .setPhoneNumber("+88"+ binding.etPhone.getText().toString().trim())
